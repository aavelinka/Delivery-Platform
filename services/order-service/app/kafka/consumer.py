...
class CourierEventsConsumer:
    ...
    async def start(self) -> None:
        ...
        self._consumer = AIOKafkaConsumer(
            self.settings.kafka_couriers_topic,
            bootstrap_servers=self.settings.kafka_bootstrap_servers,
            client_id=f"{self.settings.kafka_client_id}-couriers-consumer",
    ...
    async def _consume_loop(self) -> None:
        ...
        while not self._stopped.is_set():
            try:
                ...
                logger.exception("Failed to handle courier event: %s", exc)
    ...
    async def _handle_event(self, event: dict[str, Any], topic: str | None = None) -> None:
        ...
        with start_trace(
            ...
            attributes={
                ...
                "messaging.destination.name": topic or self.settings.kafka_couriers_topic,
